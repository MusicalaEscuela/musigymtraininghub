...
11. Entrar como estudiante y agregar autoevaluación/canción deseada.
12. Generar informe mensual.
...
- Crear un módulo de IA real para MusiCoach con API segura desde backend/Cloud Function.
